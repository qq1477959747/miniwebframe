...
def index(ret):
    ...
    # 创建Connection连接
    conn = connect(host='localhost', port=3306, user='root', password='1234', database='stock_db', charset='utf8')
    # 获得Cursor对象
    cs = conn.cursor()
...
def update_focus(ret):
    ...
    note_info = stock_infos[0]  # 获取备注信息
    cs.close()
    conn.close()
